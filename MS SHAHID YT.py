...
def cutter():
    clear()
    print("Enter File Path / File Location \n")
    shahid = input('Put File Name:')
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +shahid)
    os.system('sort -r '+shahid+' | uniq > '+shahid)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + shahid )
    print("New File Saved:" + shahid )
    print(47*'-')
    input(f"{S} Press Enter To Back SHAHID Menu ")
    SSB(allkey)       
